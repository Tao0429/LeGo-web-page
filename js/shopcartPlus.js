...
$(function() {
    ...
    var $tbodyInputs = $('tbody input[type=checkbox]'); //表格中的每一行的全选框
    ...
    /*
      计算总价的全选
        ...
        1.把计算总价的全选按钮 绑定点击事件 获取选择状态(true / false)
        2.把状态给表头的全选
        3.把状态给表格中的选择框
    */
    ...
    */
    ...
    $('.add').click(function() { //给增加绑定事件
        var count = parseInt($(this).next().val()); //取后面输入的值
    ...
    /*
       减法功能：
         1.给 - 绑定点击事件
         2.点击的时候，获取前面输入框的值
         3.输入框的值自减 边界判断 如果小于，那么等于1 否则等于自己
    ...
    function allTotal() {
        ...
        $('tbody input[type=checkbox]').each(function() { //获取所有表格中选择框 循环
            var checkState = $(this).prop('checked'); //获取选中状态
